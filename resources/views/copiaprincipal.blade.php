      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            <h1> {{$itemhome->titulo}} <span></span></h1>
...
<div id="about">
  ...
  <div class="container">
        <div class="row">
      <div class="col-xs-12 col-md-6" > <img src="imgs/group75.png" class="img-responsive" alt=""> </div>
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <h2 class="color1"> QUIENES <span class="color2">SOMOS</span></h2>
          <p id="derecha">
            {{$about = '1';}}
...
<div id="services" class="text-center">
  ...
  <div class="container">
    <div class="section-title">
      ...
      <p> @foreach ($services as $itemservices)
        {{$itemservices->descripcion}}
    @endforeach </p>
    </div>
    <div class="row">
      <div class="col-md-4"> <img src="{{ asset($itemservices->imagen) }}" alt="">
        <div class="service-desc">
          <h3> @foreach ($services as $itemservices)
            {{$itemservices->titulo_imagen}}
        @endforeach </h3>
          <p>@foreach ($services as $itemservices)
            {{$itemservices->descripcion_imagen}}
        @endforeach </p>
        </div>
      </div>
      <div class="col-md-4"> <img src="{{ asset($itemservices->imagen) }}" alt="">
...
<div id="portfolio" class="text-center">
  <div class="container " >
    <div class="section-title">
      ...
      <p> @foreach ($galleri as $itemgalleri)
        {{$itemgalleri->descripcion}}
        @endforeach </p>
    </div>
    <div class="row">
      <div class="portfolio-items">
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="{{ asset($itemgalleri->imagen) }}" title="Project Title" data-lightbox-gallery="gallery1">
      ...
      <div class="col-md-4">
        <div class="testimonial">
          ...
          <div class="testimonial-content">
            <p>
              @foreach ($testimonials as $itemtestimonials)
              {{$itemtestimonials->descripcion_titulo}}
              @endforeach
            </p>
